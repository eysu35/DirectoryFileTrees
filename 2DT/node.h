...
/*
   Given a parent node, a directory string dir and a type (0 indicating
   directory and 1 indicating file), returns a new
...
/*
  Returns n's type: 0 for directory and 1 for 
  file.
*/
...
/*
  Returns the number of child directories a directory
  node n has or NULL if n is a file node.
*/
size_t Node_getNumChildren(Node_T n);

/*
   If n is a file node, return NULL. Otherwise, 
...
/*
   ...
   and if node is dir node. Otherwise returns NULL.
*/
